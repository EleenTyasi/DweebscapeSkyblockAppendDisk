...
public class ApndglstcrftprocProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		}.hasRecipe(entity, new ResourceLocation("dwbscpsad:apndglowstone"))) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("dwbscpsad:apndgstcrft"));
