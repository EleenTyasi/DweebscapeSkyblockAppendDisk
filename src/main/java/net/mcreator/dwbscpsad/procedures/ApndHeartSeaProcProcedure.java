...
public class ApndHeartSeaProcProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		}.hasRecipe(entity, new ResourceLocation("dwbscpsad:apnd_heart_sea"))) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("dwbscpsad:apnd_heart_sea_adv"));
