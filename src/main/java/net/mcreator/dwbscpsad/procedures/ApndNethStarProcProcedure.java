...
public class ApndNethStarProcProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		}.hasRecipe(entity, new ResourceLocation("dwbscpsad:apndnethstar"))) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("dwbscpsad:apnd_neth_star_adv"));
